        ...
        <div className="lg:container lg:mx-auto grid lg:grid-cols-6 grid-cols-1 lg:gap-x-10 lg:mt-14 mt-5 lg:px-0 px-2">
          <div className="lg:col-span-4 w-full">
            ...
            <p className="lg:text-md text-sm">
              ...
              corporis quidem omnis expedita similique magni commodi quo quis
              quia quisquam. Eius cupiditate ullam cum, placeat in maxime
              eveniet repellendus repudiandae dolores possimus nemo, explicabo
              distinctio reprehenderit repellat esse assumenda culpa.
            </p>
            <p className="mt-3 lg:text-md text-sm">
              ...
              hic aliquid ipsum fugit deleniti totam necessitatibus culpa
              possimus repellat? Perferendis cupiditate nisi impedit
              consequatur, architecto dolorum qui? Earum, explicabo nulla
              possimus quisquam voluptas fugiat sapiente, cum maxime nesciunt
              eligendi nisi, rerum qui quos? Quasi quibusdam reiciendis aliquid
              eaque nulla ex.
            </p>
          </div>
